...
python scripts/celebA_sweep.py --val_split -p $val_split --seed $seed --part1_model_epochs -1 --part1_save_best --run_test --part2_loss_type group_dro --part2_reweight --part1_lr $part1_lr --part1_wd $part1_wd --part2_n_epochs $part2_n_epochs --part2_lr 1e-5 --part2_wd 1e-5 --run_part1
